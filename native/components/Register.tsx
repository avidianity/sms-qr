...
export function Register(
  props: NativeStackScreenProps<RootStackParamList, "Update">
) {
  ...
  const hasMethod =
    props?.route?.params?.method && props?.route?.params?.method.length > 0;
        ...
        <View style={formStyles.container}>
          ...
          <View style={formStyles.form}>
            <Formik
              ...
              validationSchema={
                hasUser ? updateValidationSchema : registerValidationSchema
              }
              onSubmit={(values, { setSubmitting }) => {
                ...
                if (tmpValues.number)
                  tmpValues.number = "0" + tmpValues["number"];
              ...
              {({
                ...
                return (
                  <View>
                    ...
                    {errors.number && (
                      <Text style={formStyles.errorText}>
                        {CapitalizeFirstLetter(errors.number)}
                      </Text>
                    )}
                    <PhoneInput
                    ...
                    {!(
                      props?.route?.params &&
                      Object.keys(props?.route?.params).length > 0
                    ) && (
                      <View style={formStyles.footerView}>
                        <Text style={formStyles.text1}>
